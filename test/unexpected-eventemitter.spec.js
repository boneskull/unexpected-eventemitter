...
describe('unexpected-eventemitter', function () {
  ...
  describe('to emit from', function () {
    describe('when EventEmitter does not emit an expected event', function () {
      it('should throw', function () {
        expect(() => expect(() => {}, 'to emit from', ee, eventName),
          'to throw', new RegExp(`to emit from EventEmitter, '${eventName}'`));
      });
    });
    ...
    describe('when EventEmitter emits an expected event', function () {
      ...
      describe('and that event is "error"', function () {
        ...
        it('should not throw', function () {
          expect(() => expect(() => ee.emit(eventName), 'to emit from', ee,
            eventName), 'not to throw');
        });
      });
    });
  });
  ...
  describe('to emit a value from', function () {
    ...
    describe('when EventEmitter does not emit an expected event', function () {
      it('should throw', function () {
        expect(() => expect(() => {}, 'to emit from', ee, eventName, value),
          'to throw',
    ...
    describe('when EventEmitter emits an expected event', function () {
      describe('with an unexpected value', function () {
        it('should throw', function () {
          expect(
            () => expect(() => ee.emit(eventName, 'baz'), 'to emit from', ee,
              eventName, value), 'to throw', new RegExp(
      ...
      describe('with an expected value', function () {
        it('should not throw', function () {
          expect(
            () => expect(() => ee.emit(eventName, value), 'to emit from', ee,
              eventName, value), 'not to throw');
        });
      ...
      describe('with unexpected values', function () {
        ...
        it('should throw', function () {
          expect(() => expect(() => ee.emit(eventName, values[0], 'bar'),
            'to emit from', ee, eventName, ...values), 'to throw', new RegExp(
      ...
      describe('with more values than were expected', function () {
        ...
        it('should not throw', function () {
          expect(() => expect(() => ee.emit(eventName, ...values.concat('bar')),
            'to emit from', ee, eventName, ...values), 'not to throw');
        });
      });
    });
  });
  ...
  describe('not to emit from', function () {
    describe('when EventEmitter does not emit an expected event', function () {
      it('should not throw', function () {
        expect(() => expect(() => {}, 'not to emit from', ee, 'foo'),
          'not to throw');
      });
    });
    ...
    describe('when EventEmitter emits an expected event', function () {
      it('should throw', function () {
        expect(
          ...
          'to throw', /not to emit from EventEmitter, 'foo'/);
      });
    });
  });
});
